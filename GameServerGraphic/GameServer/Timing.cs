        ...
        public static Timing Instance
        {
            get
            {
                if (_instance == null)
                {
					...
					if (Form1.instanceTiming == null)
						Form1.instanceTiming = new Timing();

					_instance = Form1.instanceTiming;
...
//#endif
        ...
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallDelayed(float delay, System.Action action, TroopComponents cancelWith)
        {
        ...
        /// <param name="cancelWith">A GameObject that will be checked to make sure it hasn't been destroyed before calling the action.</param>
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public CoroutineHandle CallDelayedOnInstance(float delay, System.Action action, TroopComponents cancelWith)
        {
        ...
        /// <param name="segment">The timing segment that the call should be made in.</param>
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public static CoroutineHandle CallDelayed(float delay, Segment segment, System.Action action, TroopComponents gameObject)
        {
        ...
        /// <param name="segment">The timing segment that the call should be made in.</param>
        /// <returns>The handle to the coroutine that is started by this function.</returns>
        public CoroutineHandle CallDelayedOnInstance(float delay, Segment segment, System.Action action, TroopComponents gameObject)
        {
            return action == null ? new CoroutineHandle() : RunCoroutineOnInstance(_DelayedCall(delay, action, gameObject), segment);
        }

        private IEnumerator<float> _DelayedCall(float delay, System.Action action, TroopComponents cancelWith)
        {
...
public static class MECExtensionMethods2
{
    ...
    public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine, TroopComponents gameObject)
    {
        while (MEC.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject.enabled /*&& gameObject.activeInHierarchy*/ && coroutine.MoveNext()))
    ...
    /// <returns>The modified coroutine handle.</returns>
    public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine, TroopComponents gameObject1, TroopComponents gameObject2)
    {
        while (MEC.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1.enabled/* && gameObject1.activeInHierarchy*/ && 
                gameObject2.enabled && /*gameObject2.activeInHierarchy &&*/ coroutine.MoveNext()))
            yield return coroutine.Current;
    }
    ...
    public static IEnumerator<float> CancelWith(this IEnumerator<float> coroutine,
        TroopComponents gameObject1, TroopComponents gameObject2, TroopComponents gameObject3)
    {
        while (MEC.Timing.MainThread != System.Threading.Thread.CurrentThread || (gameObject1.enabled /*&& gameObject1.activeInHierarchy*/ && 
                gameObject2.enabled && /*gameObject2.activeInHierarchy &&*/ gameObject3.enabled && /*gameObject3.activeInHierarchy && */coroutine.MoveNext()))
            yield return coroutine.Current;
    }
}
