...
public class Client
{
	...
	//public NormalComponentsObject playerGameObject;
	public bool hasSendMatchmaking = false;
	...
	{
		//playerGameObject = new NormalComponentsObject(new Transform(Vector3.zero,);
		//playerGameObject = GameServer.Object.Instantiate(cleintGameObject);
		//playerGameObject.name = "Player " + id;
		player = new Player(id, _playerName);
		//player = playerGameObject.AddComponent<Player>();
		//player.InitializePlayer(id, _playerName);
	}
