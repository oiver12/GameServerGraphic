...
namespace Pathfinding.Voxels {
	...
	public partial class Voxelize {
		...
		public void VoxelizeInput (Pathfinding.Util.GraphTransform graphTransform, Bounds graphSpaceBounds) {
			...
			// Finally add min
			Matrix4x4 voxelMatrix = Matrix4x4.TRS(graphSpaceBounds.min, Quaternion.Identity, Vector3.one) * Matrix4x4.CreateScale(new Vector3(cellSize, cellHeight, cellSize));
