...
namespace Pathfinding {
	...
	public abstract class AIBase /*: MonoBehaviour*/
	{
		...
		public AIBase(/*Transform tr, Seeker sk, RichAI rich) : base(tr, sk, rich)*/)
		{
		...
		public virtual void OnEnable (TroopComponents mon) {
			troopObject = mon;
			FindComponents();
		...
		protected void ApplyGravity (float deltaTime) {
			...
			if (usingGravity) {
				...
				velocity2D += movementPlane.ToPlane(deltaTime * gravity, out verticalGravity);
		...
		public void FinalizeRotation (Quaternion nextRotation) {
