	...
	public class TinyJsonSerializer {
		...
		void Serialize (System.Object obj) {
			...
			if (serializers.ContainsKey(type)) {
				...
				output.Append("]");
			//} else if (obj is GameServer.Object) {
			//	SerializeUnityObject(obj as GameServer.Object);
			} else {
#if NETFX_CORE
...
//		void SerializeUnityObject (GameServer.Object obj) {
//			// Note that a GameServer can be destroyed as well
//			if (obj == null) {
//				Serialize(null);
//				return;
//			}
...
//		}
	...
	public class TinyJsonDeserializer {
		...
		////GameServer.Object DeserializeUnityObject () {
		////	Eat("{");
		...
		//GameServer.Object DeserializeUnityObjectInner () {
		...
		//		foreach (var helper in GameServer.Object.FindObjectsOfType<UnityReferenceHelper>()) {
		...
		//		GameServer.Object[] objs = Resources.LoadAll(name, type);
